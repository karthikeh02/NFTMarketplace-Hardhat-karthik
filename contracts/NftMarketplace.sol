...
contract NftMarketplace is ReentrancyGuard {
        ...
        isOwner(nftAddress, tokenId, msg.sender)
    {
        ...
        // 1. Send the NFT to the contract . Transfer -> Contract "hold" the NFT(This is gas expensive)
    ...
    function buyItem(
        ...
        // sending the money to the user NOTTTT
        // Have them withdraw the money YESSSSS
